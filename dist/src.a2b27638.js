...
},{"hyperapp":"node_modules/hyperapp/src/index.js"}],"node_modules/lodash-es/_freeGlobal.js":[function(require,module,exports) {
...
},{"redux":"node_modules/redux/es/index.js","redux-devtools-extension":"node_modules/redux-devtools-extension/index.js"}],"node_modules/d3/dist/package.js":[function(require,module,exports) {
"use strict";
...
function getLogger(name) {
  function _log(levelLogger, level) {
    for (var _len = arguments.length, args = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
      args[_key - 2] = arguments[_key];
    }

    levelLogger.apply(void 0, ["".concat(level.toUpperCase(), " ").concat(name, ":")].concat(args));
  }
  ...
  return {
    ...
    debug: function debug() {
      ...
      return _log.apply(void 0, [console.debug, 'debug'].concat(args));
    },
    log: function log() {
      ...
      return _log.apply(void 0, [console.log, 'log'].concat(args));
    },
    warn: function warn() {
      ...
      return _log.apply(void 0, [console.warn, 'warn'].concat(args));
    },
    error: function error() {
      ...
      return _log.apply(void 0, [console.error, 'error'].concat(args));
    }
    /* eslint-enable no-console */

  };
}
},{}],"src/supporting_modules/Globals.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Globals, null, [{
    ...
    key: "setModuleRun",
    value: function setModuleRun(i) {
      this.mRun = i;
    }
  }, {
    key: "getModuleRun",
    value: function getModuleRun() {
      return this.mRun;
    ...
    key: "setNodeLabels",
    value: function setNodeLabels(i) {
      this.nodeLabels = i;
    }
  }, {
    key: "getNodeLabels",
    value: function getNodeLabels() {
      return this.nodeLabels;
    } // Holds zoom handler

  }, {
    key: "setZoomHandler",
    value: function setZoomHandler(i) {
      this.zoomHandler = i;
    }
  }, {
    key: "getZoomHandler",
    value: function getZoomHandler() {
...
},{}],"src/supporting_modules/transformations.js":[function(require,module,exports) {
"use strict";
...
exports.localToGlobalCoord = localToGlobalCoord;
exports.globalToLocalCoord = globalToLocalCoord;

var _logger = require("./../logger");

var _Globals = require("./../supporting_modules/Globals");
 ...
 */
var logger = (0, _logger.getLogger)('transformations');

function getTransform(obj) {
  var str = obj.attr('transform');
  var temp = str.substring(str.indexOf('(') + 1, str.indexOf(')')).split(',');
  str = str.substring(str.indexOf(')') + 1).trim();
  temp[2] = str.substring(str.indexOf('(') + 1, str.indexOf(')'));
  return [parseFloat(temp[0]), parseFloat(temp[1]), parseFloat(temp[2])];
}

function localToGlobalCoord(coord) {
  var winSize = _Globals.Globals.getWinSize();
...
function globalToLocalCoord(coord) {
  var winSize = _Globals.Globals.getWinSize();
...
},{"./../logger":"src/logger.js","./../supporting_modules/Globals":"src/supporting_modules/Globals.js","d3":"node_modules/d3/index.js"}],"src/graph_modules/graph_zoom.js":[function(require,module,exports) {
"use strict";
...
var Trans = _interopRequireWildcard(require("./../supporting_modules/transformations"));

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

var logger = (0, _logger.getLogger)('graph_zoom');
var moduleName = 'GraphZoom'; // Variables
...
function start() {
  if (Trans.getTransform(_Globals.Globals.getGraph()) === null || Trans.getTransform(_Globals.Globals.getGraph()) === undefined) {
    _Globals.Globals.getGraph().attr('transform', d3.zoomIdentity);
  }

  gTransform = _Globals.Globals.getGraph();

  if (_Globals.Globals.getWinSize() === null || _Globals.Globals.getWinSize() === undefined) {
    _Globals.Globals.setWinSize({
      minX: 0,
  ...
  WINSIZE = _Globals.Globals.getWinSize();
}
...
function update() {
  var zoomActions = function zoomActions() {
    ...
    _Globals.Globals.getGraph().attr('transform', gTransform);

    _Globals.Globals.getNodeLabels().selectAll('text').attr('font-size', 16 / gTransform.k).attr('x', function (d) {
      return d.x - d.content.length * 4 / gTransform.k;
    }).attr('y', function (d) {
      if (gTransform.k > 2) {
        return d.y;
      }
  ...
  zoomHandler = d3.zoom().scaleExtent([1 / 10, 10]).on('zoom', zoomActions);
  zoomHandler(_Globals.Globals.getSVG()); // Disable double click zooming
...
// Imports
var logger = (0, _logger.getLogger)('node_highlight');
var moduleName = 'NodeHighlight';
exports.moduleName = moduleName;
...
function update() {
  var nodes = _Globals.Globals.getNodes().selectAll('circle');

  nodes.on('mouseover', highlight).on('mouseout', unhighlight);
  return 1;
} // Functions
...
function highlight(d, i) {
  ...
  if (temp === d3.select(this).attr('orig_color')) {
    d3.select(this).attr('fill', d3.rgb(temp).brighter()).style('stroke-width', '4px');
  }
}

function unhighlight(d, i) {
  var temp = d3.select(this).attr('orig_color');

  if (temp !== d3.select(this).attr('fill')) {
    d3.select(this).attr('fill', temp).style('stroke-width', '2px');
  }
}
},{"./../logger":"src/logger.js","./../supporting_modules/Globals":"src/supporting_modules/Globals.js","d3":"node_modules/d3/index.js"}],"src/graph_modules/drag_nodes.js":[function(require,module,exports) {
"use strict";
...
var logger = (0, _logger.getLogger)('drag_nodes');
var moduleName = 'DragNodes'; // Variables
...
function start() {
  ...
  WINSIZE = _Globals.Globals.getWinSize();
  links = _Globals.Globals.getLinks().selectAll('line');
  nodes = _Globals.Globals.getNodes().selectAll('circle');
  labels = _Globals.Globals.getNodeLabels().selectAll('text');
  return 1;
}
...
var drag = d3.drag() // eslint-disable-next-line max-statements
.on('drag', function (d, i) {
  // Drag node
  d.x += d3.event.dx + d.x > WINSIZE.maxX || d.x + d3.event.dx < WINSIZE.minX ? 0 : d3.event.dx;
  d.y += d3.event.dy + d.y > WINSIZE.maxY || d.y + d3.event.dy < WINSIZE.minY ? 0 : d3.event.dy;
  ...
  labels.each(function (n) {
    if (n.nodeId == i) d3.select(this).attr('x', d.x).attr('y', d.y);
  }); // Pan graph

  var temp = Trans.localToGlobalCoord(d);
  var gTransform = Trans.getTransform(_Globals.Globals.getGraph());
  ...
  _Globals.Globals.getSVG().call(_Globals.Globals.getZoomHandler().transform, d3.zoomIdentity.translate(gTransform[0], gTransform[1]).scale(gTransform[2]));

  WINSIZE.minX = -gTransform[0] / gTransform[2];
  WINSIZE.maxX = document.documentElement.clientWidth / gTransform[2] - (gTransform[0] + 15) / gTransform[2];
  WINSIZE.minY = -gTransform[1] / gTransform[2];
  WINSIZE.maxY = document.documentElement.clientHeight / gTransform[2] - (gTransform[1] + 15) / gTransform[2];
});
},{"./../logger":"src/logger.js","./../supporting_modules/Globals":"src/supporting_modules/Globals.js","d3":"node_modules/d3/index.js","./../supporting_modules/transformations":"src/supporting_modules/transformations.js"}],"src/graph_modules/center_node.js":[function(require,module,exports) {
"use strict";
...
var logger = (0, _logger.getLogger)('center_node');
var moduleName = 'NodeCenter';
exports.moduleName = moduleName;
...
function update() {
  ...
  nodes.on('click', function (d) {
    var gTransform = Trans.getTransform(_Globals.Globals.getGraph());
    var x = gTransform[0] + document.documentElement.clientWidth / 2 - Trans.localToGlobalCoord(d).x;
    var y = gTransform[1] + document.documentElement.clientHeight / 2 - Trans.localToGlobalCoord(d).y;

    _Globals.Globals.getSVG().transition().duration(250).call(_Globals.Globals.getZoomHandler().transform, d3.zoomIdentity.translate(x, y).scale(gTransform[2]));
  });
  return 1;
}
},{"./../logger":"src/logger.js","./../supporting_modules/Globals":"src/supporting_modules/Globals.js","d3":"node_modules/d3/index.js","./../supporting_modules/transformations":"src/supporting_modules/transformations.js"}],"src/graph_modules/graph_move.js":[function(require,module,exports) {
"use strict";
...
var logger = (0, _logger.getLogger)('graph_move');
var moduleName = 'GraphMove';
exports.moduleName = moduleName;
var gTransform = null;

function start() {
  gTransform = Trans.getTransform(_Globals.Globals.getGraph());
}

function update() {
  d3.select('body').on('keypress', function () {
    gTransform = Trans.getTransform(_Globals.Globals.getGraph());
    var temp = 50 * gTransform[2];
...
},{"./../logger":"src/logger.js","./../supporting_modules/Globals":"src/supporting_modules/Globals.js","d3":"node_modules/d3/index.js","./../supporting_modules/transformations":"src/supporting_modules/transformations.js"}],"src/backend_modules/module_loader.js":[function(require,module,exports) {
"use strict";
...
var GraphZoom = _interopRequireWildcard(require("./../graph_modules/graph_zoom"));

var NodeHighlight = _interopRequireWildcard(require("./../graph_modules/node_highlight"));

var DragNodes = _interopRequireWildcard(require("./../graph_modules/drag_nodes"));

var NodeCenter = _interopRequireWildcard(require("./../graph_modules/center_node"));

var GraphMove = _interopRequireWildcard(require("./../graph_modules/graph_move"));

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

var logger = (0, _logger.getLogger)('module_loader');
// Holds all import objects
var modules = [NodeHighlight, GraphZoom, DragNodes, NodeCenter, GraphMove]; // Used to load all modules to be run in the system

function loadModules() {
  var opt = _Globals.Globals.getModuleRun();
...
},{"./../logger":"src/logger.js","./../supporting_modules/Globals":"src/supporting_modules/Globals.js","./../graph_modules/graph_zoom":"src/graph_modules/graph_zoom.js","./../graph_modules/node_highlight":"src/graph_modules/node_highlight.js","./../graph_modules/drag_nodes":"src/graph_modules/drag_nodes.js","./../graph_modules/center_node":"src/graph_modules/center_node.js","./../graph_modules/graph_move":"src/graph_modules/graph_move.js"}],"src/renderer.js":[function(require,module,exports) {
"use strict";
...
var MLoader = _interopRequireWildcard(require("./backend_modules/module_loader"));

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

/* eslint-disable max-statements */
var logger = (0, _logger.getLogger)('renderer');

function render(data, callbacks) {
  logger.debug('Drawing graph nodes and links');

  var svg = _Globals.Globals.getSVG();

  var g = _Globals.Globals.getGraph();

  var c10 = d3.scaleOrdinal(d3.schemeCategory10);
  var links = g.selectAll('.link').data(data.links).enter();

  _Globals.Globals.setLinks(links);

  var lines = links.append('line').attr('class', 'link').attr('x1', function (l) {
  ...
  var nodes = g.attr('class', 'node').selectAll('.node').data(data.nodes).enter();

  _Globals.Globals.setNodes(nodes);

  var circles = nodes.append('circle').attr('cx', function (d) {
    return d.x;
  }).attr('cy', function (d) {
    return d.y;
...
},{"d3":"node_modules/d3/index.js","./logger":"src/logger.js","./supporting_modules/Globals":"src/supporting_modules/Globals.js","./backend_modules/module_loader":"src/backend_modules/module_loader.js"}],"src/d3-graph.js":[function(require,module,exports) {
"use strict";
...
var logger = (0, _logger.getLogger)('d3-graph');
...
function () {
  ...
  _createClass(D3Graph, [{
    ...
    value: function init() {
      ...
      if (document.d3Initialized && dimensions.height === this._height && dimensions.width === this._width) {
      ...
      _Globals.Globals.setGraph(this._g); // Module Options
      ...
      _Globals.Globals.setModuleRun(options);
...
},{"d3":"node_modules/d3/index.js","./logger":"src/logger.js","./supporting_modules/Globals":"src/supporting_modules/Globals.js","./renderer":"src/renderer.js"}],"src/graph-view-component.js":[function(require,module,exports) {
"use strict";
...
var _d3Graph = _interopRequireDefault(require("./d3-graph"));
...
function _default(dimensions, callbacks, graphData) {
  return html.div({
    ...
    onupdate: function onupdate(el, prevAttrs) {
      if (dimensions != prevAttrs.dimensions) d3Graph.init(el, {
        height: dimensions.height,
        width: dimensions.width
      });
      if (callbacks != prevAttrs.callbacks) d3Graph.init(el, {
        height: dimensions.height,
        width: dimensions.width
      });
      if (graphData != prevAttrs.graphData) d3Graph.render(graphData, callbacks);
    }
  });
}
},{"@hyperapp/html":"node_modules/@hyperapp/html/dist/html.js","./d3-graph":"src/d3-graph.js","./logger":"src/logger.js"}],"src/editor-component.js":[function(require,module,exports) {
"use strict";
...
function _default(content, _oninput, onClose) {
  return html.div({
    id: 'editor-container'
  }, [html.button({
    id: 'editor-close',
...
var _hyperappReduxDevtools = _interopRequireDefault(require("hyperapp-redux-devtools"));

var _graphViewComponent = _interopRequireDefault(require("./graph-view-component"));

var _editorComponent = _interopRequireDefault(require("./editor-component"));
...
var actions = {
  ...
  onWindowResize: function onWindowResize(_ref) {
  ...
  onGraphClick: function onGraphClick(ev) {
    return function (state, actions) {
  ...
  onEditorInput: function onEditorInput(content) {
    return function (state, actions) {
      ...
      var selectedNodeIndex = state.graphData.nodes.findIndex(function (n) {
        return n.name === state.selectedNode.name;
      });
      ...
      var newList = _toConsumableArray(oldList);
