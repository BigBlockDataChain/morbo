...
export default function view(state: IState, actions: IActions, mirrorMarkEditor: any) {
  return html.div(
    ...
    [
      ...
      html.div(
        {class: 'ocr-editor-component-toolbar'},
        [
          html.select(
            {
              class: 'ocr-editor-component-language-selection',
          ...
          html.div({class: 'ocr-editor-component-toolbar-expander'}),
          ...
          /* OCR Progress */
          html.div({class: 'ocr-editor-component-progress'}, [
            state.ocrProgress &&
